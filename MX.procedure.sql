...
begin 
Insert_Cd(1,'cd 1',10000,'this is the cd 1');
end;
...
begin 
Insert_Cd(51,'cd 51',10000,'this is the cd 51');
end;
...
begin 
    ...
    if(dem>0) then 
        if(n_import_cd_id >0 and n_import_cd_id<=100) then
            insert into C##M1.import_cd@DB_M1 (import_cd_id ,stock_id ,brand_store_id) values (n_import_cd_id,n_stock_id,***);
        else
        ...
        if(dem>0) then 
            if(n_import_cd_id >100 and n_import_cd_id<=200) then
                insert into C##M2.import_cd@DB_M2 (import_cd_id ,stock_id ,brand_store_id) values (n_import_cd_id,n_stock_id,***);
            else
...
begin
    Create_import_cd(1,1);
end;

select * from C##M1.import_cd@DB_M1;

begin
    Create_import_cd(101,11);
end;
select * from C##M2.import_cd@DB_M2;


begin
    Create_import_cd(201,11);
end;
...
select * from cd;
begin
    insert_import_cd_detail(101,51,5);
end;
...
begin
--update_quatity_import_cd_detail 
update_quatity_import_cd_detail (1, 1,3 );
end;
...
begin
--update_quatity_import_cd_detail 
update_quatity_import_cd_detail (101, 51, 8);
end;
